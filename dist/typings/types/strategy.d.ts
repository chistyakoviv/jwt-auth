...
export declare type StrategyPartialOptions<Options extends StrategyOptions> = PartialExcept<Options, keyof StrategyOptions>;
export interface TokenableStrategyOptions extends StrategyOptions {
    token: TokenOptions;
    endpoints: EndpointsOption;
}
export interface TokenableStrategy<OptionsT extends TokenableStrategyOptions = TokenableStrategyOptions> extends Strategy<OptionsT> {
    token: Token;
...
export interface RefreshableStrategy<OptionsT extends RefreshableStrategyOptions = RefreshableStrategyOptions> extends TokenableStrategy<OptionsT> {
